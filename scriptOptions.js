...
fontSizeBtn.addEventListener('change', function () {
  ...
  activeOptionsState.fontSize = selectedFontSize + 'px';
});

selectFontFamily.addEventListener('change', function(){
  const valueOfFont = selectFontFamily.value;

  activeCell.style.fontFamily = valueOfFont;
  activeOptionsState.fontFamily = valueOfFont;
})
